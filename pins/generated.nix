...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  SDL2 = {
    pname = "SDL2";
    version = "release-2.32.4";
    src = fetchFromGitHub {
      owner = "libsdl-org";
      repo = "SDL";
      rev = "release-2.32.4";
      fetchSubmodules = false;
      sha256 = "sha256-4yUJkttUAbDC/5IdcCFY5ZTIG1qsxEEOjTTuplXV/p4=";
    };
  };
  SDL2_android = {
    pname = "SDL2_android";
  ...
  fpc = {
    pname = "fpc";
    version = "5cf2fac78cfccd72dd2ed6f6dbcf480edc680f46";
    src = fetchgit {
      url = "https://gitlab.com/freepascal.org/fpc/source";
      rev = "5cf2fac78cfccd72dd2ed6f6dbcf480edc680f46";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sparseCheckout = [ ];
      sha256 = "sha256-VKR6Cc0ASDjURX93EeOrblrxsTEiaof/2+DmQ6EBaQw=";
    };
    date = "2025-05-02";
  };
  game-music-emu = {
  ...
  lazarus = {
    pname = "lazarus";
    version = "f2e1746dfa613962dcbd70c387a9195d0cf5e72f";
    src = fetchgit {
      url = "https://gitlab.com/freepascal.org/lazarus/lazarus";
      rev = "f2e1746dfa613962dcbd70c387a9195d0cf5e72f";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sparseCheckout = [ ];
      sha256 = "sha256-2Awc+9MMECN0vGa3wZtKgtjGI0xKArbERWIlF7HZdAQ=";
    };
    date = "2025-05-03";
  };
  libmodplug = {
